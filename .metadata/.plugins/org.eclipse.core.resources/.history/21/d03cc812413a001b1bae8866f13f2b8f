...
public class RequestService {
	...
	public Request getById(Long id) {
		...
		return result.orElseThrow(() -> new NotFoundException("O id desta request não existe = " + id));
	}
	...
	public PageModel<Request> listAllOnLazyMode( PageRequestModel pr){
		org.springframework.data.domain.Pageable pageable = PageRequest.of(pr.getPage(), pr.getSize());
